...
execute if score &playersDead multipack.temp matches 1 run summon text_display ~ ~ ~ {alignment:"center",Tags:["multipack.grave_display"],transformation:{left_rotation:[0f,0f,0.125f,1f],right_rotation:[0f,1f,0f,1f],translation:[-0.58f,0.6f,0f],scale:[0.4f,0.4f,0.4f]},text:'{"selector":"@p[scores={multipack.death=1..}]"}',background:0}
