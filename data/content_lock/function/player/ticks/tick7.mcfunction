...
execute if entity @r[tag=content_lock.spectator] if entity @e[tag=content_lock.boss] as @a[tag=content_lock.spectator] run function content_lock:mobs/bosses/turn_off_spectator
