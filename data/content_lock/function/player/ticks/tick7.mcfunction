...
execute if score @r[scores={content_lock.time_since_death=21..},tag=content_lock.level_up_menu_up] content_lock.time_since_rest matches 1.. as @a[tag=content_lock.level_up_menu_up,scores={content_lock.time_since_rest=1..,content_lock.time_since_death=21..}] run function content_lock:player/passives/sleep/woke_up
...
execute if entity @r[tag=content_lock.spectator] unless entity @r[tag=!content_lock.spectator] as @a[tag=content_lock.spectator] run function content_lock:mobs/bosses/turn_off_spectator
...
execute if entity @r[tag=content_lock.spectator] if entity @e[tag=content_lock.boss] as @a[tag=content_lock.spectator] run function content_lock:mobs/bosses/spectator_counter
...
execute if entity @r[scores={content_lock.enchantment.lightstruck=1..}] as @a[scores={content_lock.enchantment.lightstruck=1..}] run scoreboard players remove @s content_lock.enchantment.lightstruck 1