...
execute if entity @s[tag=content_lock.silver_tape_used_up] run return run playsound content_lock:item.silver_tape.end player @a ~ ~ ~ 1 1
execute if entity @s[tag=content_lock.silver_tape_used] run return run playsound content_lock:item.silver_tape player @a ~ ~ ~ 1 1
playsound content_lock:item.silver_tape.fail player @a ~ ~ ~ 1 1
