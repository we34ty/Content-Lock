...
execute if score @s content_lock.undead_book_charge matches 1 run playsound minecraft:item.content_lock.spell.charging player @a ~ ~ ~ 1 1
...
$execute if score @s content_lock.undead_book_charge matches $(attack_speed) run playsound minecraft:item.content_lock.spell.undead_book player @a ~ ~ ~ 1 1
