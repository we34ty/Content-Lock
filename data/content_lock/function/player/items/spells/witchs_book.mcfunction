...
$execute if score @s content_lock.witchs_book_charge matches $(attack_speed) positioned ~ ~1 ~ run summon area_effect_cloud ^ ^ ^1 {Tags:["content_lock.witchs_book_projectile"]}
