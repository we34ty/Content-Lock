...
execute if score @s content_lock.witchs_book_charge matches 1 run playsound minecraft:item.content_lock.spell.charging player @a ~ ~ ~ 1 1.2
...
$execute if score @s content_lock.witchs_book_charge matches $(attack_speed) positioned ~ ~1 ~ run summon area_effect_cloud ^ ^ ^1 {Tags:["content_lock.witchs_book_projectile"],custom_particle:{type:"block",block_state:"air"},Duration:0}
