data merge storage content_lock:saved_stats {damage:1.0f,range:1.0f,half_range:1.0f,attack_speed:1,healing:1,UUID:[]}
...
execute store result storage content_lock:saved_stats healing int 0.1 run attribute @s attack_damage get 1
...
function content_lock:player/items/spells/wither_heal_book/wither_heal_book with storage content_lock:saved_stats