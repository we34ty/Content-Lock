...
execute at @s rotated ~ 0 positioned ^ ^ ^2 facing entity @s eyes positioned ^ ^ ^1 as @n[type=block_display,tag=content_lock.prism_stone] rotated as @p run rotate @s ~ ~
execute at @s rotated ~ 0 positioned ^ ^ ^2 facing entity @s eyes positioned ^ ^ ^1 as @n[type=block_display,tag=content_lock.prism_stone] store result score @s content_lock.stored_y run data get entity @s Pos[1]
execute at @s run playsound content_lock:item.prism_stone.throw player @a ~ ~ ~ 1 1
