...
execute unless score @s lsp.stamina matches ..0 unless entity @s[tag=content_lock.tatsugeki.moving_forward] rotated ~ 0 positioned ^ ^ ^-4 run summon area_effect_cloud ~ ~ ~ {Tags:["content_lock.tatsugeki_movement_check"],Duration:2,custom_particle:{type:"block",block_state:"air"}} 
