...
execute as @n[tag=content_lock.tatsugeki.dolphin] at @s rotated as @p[tag=content_lock.tatsugeki.anchor_sneak] rotated ~ -60 run summon area_effect_cloud ^ ^ ^5 {Tags:["content_lock.tatsugeki.dolphin.area"],Duration:1,custom_particle:{type:"block",block_state:"air"}}
