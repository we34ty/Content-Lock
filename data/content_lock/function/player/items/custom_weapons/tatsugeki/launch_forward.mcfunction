...
execute as @e[tag=content_lock.tatsugeki.dolphin,limit=1,sort=nearest] at @s rotated as @p[tag=content_lock.tatsugeki.moving_forward] rotated ~ 0 run summon area_effect_cloud ^ ^ ^5 {Tags:["content_lock.tatsugeki.dolphin.area"],Duration:1,Radius:0.0f}
