$execute facing entity @e[tag=content_lock.tatsugeki.dolphin.area,limit=1,sort=nearest] feet positioned ^ ^ ^$(speed) run summon area_effect_cloud ~ ~ ~ {Tags:["content_lock.motion_saved_dolphin"]}
