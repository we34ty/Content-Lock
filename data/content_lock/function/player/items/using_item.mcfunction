...
execute if items entity @s weapon.mainhand *[enchantments~[{"enchantments":"content_lock:trick_switch"}]] at @s run function content_lock:player/items/custom_weapons/trick_switch/check
