...
execute if entity @p[tag=content_lock.fishing.hooked_tag,distance=10..] facing entity @p[tag=content_lock.fishing.hooked_tag] feet rotated ~ 0 run tp @s ^ ^ ^0.2
execute if entity @p[tag=content_lock.fishing.hooked_tag,distance=..3] facing entity @p[tag=content_lock.fishing.hooked_tag] feet rotated ~180 0 run tp @s ^ ^ ^0.2
