...
$execute rotated $(yaw) 0 positioned ^ ^ ^0.2 unless block ~ ~-0.2 ~ #water_filled run scoreboard players add @p[tag=content_lock.fishing.hooked_tag] content_lock.fishing.stress 15
