execute as @e[tag=content_lock.fishing.fish] at @s unless entity @n[tag=content_lock.fishing.bobber,distance=..1] run tag @s add content_lock.fishing.fish.current
