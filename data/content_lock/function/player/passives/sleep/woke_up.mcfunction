...
execute at @s if entity @s[tag=content_lock.level_up_menu_down] if entity @r[distance=0.1..] run tellraw @a [{"selector": "@s","color": "gold"},{"translate":"content_lock:notifications.leave_bed","color":"gold"}]
