execute at @s unless predicate content_lock:is_dim_light unless biome ~ ~ ~ minecraft:mushroom_fields run return run function content_lock:player/passives/sleep/random_mob_on_sleep
execute at @s unless predicate content_lock:under_roof unless biome ~ ~ ~ minecraft:mushroom_fields run return run function content_lock:player/passives/sleep/random_mob_on_sleep
...
execute unless entity @s[tag=content_lock.level_up_menu_up] run function content_lock:player/passives/sleep/level_up_menu
