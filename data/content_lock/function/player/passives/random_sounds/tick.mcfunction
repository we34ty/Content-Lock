...
execute store result score @s content_lock.temp1 run function content_lock:check_random_chance {chance:10000}
...
execute if score @s content_lock.temp1 matches 4 at @s run function content_lock:player/passives/random_sounds/sound4