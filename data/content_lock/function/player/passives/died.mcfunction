...
execute if score L content_lock.options.player.corruption matches 1 if score L content_lock.progression matches 2.. unless entity @s[tag=content_lock.corrupted_meter_full] run scoreboard players add @s content_lock.corruption_meter 2
