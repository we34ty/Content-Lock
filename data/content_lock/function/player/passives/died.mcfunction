...
execute if score L content_lock.progression matches 2.. unless entity @s[tag=content_lock.corrupted_meter_full] run scoreboard players add @s content_lock.corruption_meter 2
...
execute at @s if entity @e[tag=content_lock.boss,distance=..40] run function content_lock:mobs/bosses/reduce_player_respawns