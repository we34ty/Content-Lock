...
execute store result storage content_lock:saved_stats value float 0.05 run scoreboard players get @s content_lock.atkspd_from_level
...
execute store result storage content_lock:saved_stats value float 0.5 run scoreboard players get @s content_lock.atkspd_from_level
function content_lock:player/levels/scale_level_statistic_macro_add with storage content_lock:saved_stats

data merge storage content_lock:saved_stats {type:"attack_damage"}
execute store result storage content_lock:saved_stats value float 0.025 run scoreboard players get @s content_lock.dmg_from_level
function content_lock:player/levels/scale_level_statistic_macro_multiply with storage content_lock:saved_stats
...
execute store result storage content_lock:saved_stats value float 0.05 run scoreboard players get @s content_lock.atkrng_from_level
function content_lock:player/levels/scale_level_statistic_macro_multiply with storage content_lock:saved_stats
