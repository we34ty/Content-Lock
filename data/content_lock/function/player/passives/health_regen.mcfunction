##waits an additional tick with this tag
...
##removes the modifiers for max health given from previous healing
...
##checks if the player is supposed to regenerate health
