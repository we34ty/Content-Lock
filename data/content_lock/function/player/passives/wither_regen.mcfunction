##100 tick timer between each heal
...
execute if score @s content_lock.wither_regen.timer2 matches 100.. store result storage content_lock:saved_stats value float 1000 run scoreboard players get @s content_lock.wither_regen
