$execute unless data storage content_lock:saved_stats damage_modifiers.$(type)[$(i)] run return run scoreboard players set @s content_lock.timer1 0

$data modify storage content_lock:saved_stats damage_modifier set from storage content_lock:saved_stats damage_modifiers.$(type)[$(i)]
