...
data modify storage content_lock:weapon_stats data.damage_type set from entity @s SelectedItem.components."minecraft:custom_data"."content_lock:weapon".damage_type
