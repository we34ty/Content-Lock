...
scoreboard players remove @s content_lock.huhhealth2 100

data merge storage content_lock:saved_stats {value:0}
execute store result storage content_lock:saved_stats value float 0.01 run scoreboard players get @s content_lock.huhhealth2
