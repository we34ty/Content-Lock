...
scoreboard players add @s content_lock.temp2 1
...
data merge storage content_lock:saved_stats {value:0.0}
execute store result storage content_lock:saved_stats value double 0.00001 run scoreboard players get @s content_lock.temp2
scoreboard players operation @s content_lock.huhhealth1 %= @s content_lock.temp1
execute if score @s content_lock.huhhealth1 matches 1.. run scoreboard players add @s content_lock.huhhealth2 1
scoreboard players set @s content_lock.temp1 2
scoreboard players operation @s content_lock.huhhealth2 %= @s content_lock.temp1
execute if score @s content_lock.huhhealth2 matches 1 run function content_lock:player/passives/round_health_macro with storage content_lock:saved_stats
