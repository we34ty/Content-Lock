execute store result score @s content_lock.huhhealth1 run attribute @s max_health get 100
...
execute if score @s content_lock.huhhealth1 matches 50.. run scoreboard players add @s content_lock.huhhealth2 1
