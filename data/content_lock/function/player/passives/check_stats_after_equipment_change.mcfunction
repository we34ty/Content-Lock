...
function content_lock:player/passives/turn_potions_stackable
function content_lock:player/passives/turn_food_less_nutricious
function content_lock:player/passives/turn_soup_stackable
