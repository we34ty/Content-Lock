...
scoreboard players set @s content_lock.weapons.hit_timer 30
scoreboard players set @s content_lock.weapons.cooldown 15
...
execute if score @s content_lock.weapons.hit_nr matches 1 as @n[type=minecraft:item_display,tag=aj.weapons.root] run function animated_java:weapons/animations/axe1/play
execute if score @s content_lock.weapons.hit_nr matches 2 as @n[type=minecraft:item_display,tag=aj.weapons.root] run function animated_java:weapons/animations/axe2/play
...
execute as @n[type=minecraft:item_display,tag=aj.weapons.root] run tag @s add content_lock.weapons.axe
