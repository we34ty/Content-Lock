...
execute if score @s content_lock.weapons.hit_nr matches 1 as @n[type=minecraft:item_display,tag=aj.weapons.root] run function animated_java:weapons/animations/hoe1/play
execute if score @s content_lock.weapons.hit_nr matches 2 as @n[type=minecraft:item_display,tag=aj.weapons.root] run function animated_java:weapons/animations/hoe2/play
...
execute as @n[type=minecraft:item_display,tag=aj.weapons.root] run tag @s add content_lock.weapons.hoe
