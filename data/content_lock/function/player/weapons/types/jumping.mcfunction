...
scoreboard players set @s content_lock.weapons.cooldown 230
...
execute as @n[type=minecraft:item_display,tag=aj.weapons.root] run function animated_java:weapons/animations/jump1/play
...
execute as @n[type=minecraft:item_display,tag=aj.weapons.root] run tag @s add content_lock.weapons.hit1
execute as @n[type=minecraft:item_display,tag=aj.weapons.root] run tag @s add content_lock.weapons.jumping
