...
data merge storage content_lock:weapon_stats {pitch:0,distance:0,attack_anim_id:0}
...
#ids of 9 and 10 are reserved for running and jumping attacks respectively
execute if score @s content_lock.weapons.hit_nr matches 9 run data merge storage content_lock:weapon_stats {attack_anim_id:"_running"}
execute if score @s content_lock.weapons.hit_nr matches 10 run data merge storage content_lock:weapon_stats {attack_anim_id:"_jumping"}
