...
execute if items entity @s weapon.mainhand wooden_sword run return run function content_lock:player/weapons/attacked_macro {name:"sword",cooldown:12,visible_timer:25,max_combo:2,sound:entity.player.attack.strong,sound_pitch:0.7,anims:sword,jumping_attack:1,running_attack:9}
execute if items entity @s weapon.mainhand stone_sword run return run function content_lock:player/weapons/attacked_macro {name:"far_sword",cooldown:17,visible_timer:31,max_combo:3,sound:entity.player.attack.strong,sound_pitch:0.5,anims:sword_far,jumping_attack:3,running_attack:9}
execute if items entity @s weapon.mainhand iron_sword run return run function content_lock:player/weapons/attacked_macro {name:"far_sword",cooldown:17,visible_timer:31,max_combo:3,sound:entity.player.attack.strong,sound_pitch:0.5,anims:sword_far,jumping_attack:3,running_attack:9}
execute if items entity @s weapon.mainhand netherite_sword run return run function content_lock:player/weapons/attacked_macro {name:"far_sword",cooldown:17,visible_timer:31,max_combo:3,sound:entity.player.attack.strong,sound_pitch:0.5,anims:sword_far,jumping_attack:3,running_attack:9}
...
execute if items entity @s weapon.mainhand #minecraft:swords run return run function content_lock:player/weapons/attacked_macro {name:"sword",cooldown:12,visible_timer:25,max_combo:2,sound:entity.player.attack.strong,sound_pitch:0.7,anims:sword,jumping_attack:1,running_attack:9}
