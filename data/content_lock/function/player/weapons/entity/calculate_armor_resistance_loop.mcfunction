...
execute if data storage content_lock:saved_stats {damage_resistance:{operation:"add"}} store result score @s content_lock.huhhealth1 run data get storage content_lock:saved_stats damage_resistance.value 1000
