...
execute if score @s content_lock.attack_timer matches 25 run return run function animated_java:weapons/remove/this
...
execute if entity @s[tag=content_lock.weapons.running] if score @s content_lock.attack_timer matches 7..9 rotated ~ 0 positioned ^ ^ ^0.4 run function content_lock:player/weapons/entity/damage with storage content_lock:weapon_stats
execute if entity @s[tag=content_lock.weapons.running] if score @s content_lock.attack_timer matches 10..11 rotated ~ 0 positioned ^ ^ ^0.7 run function content_lock:player/weapons/entity/damage with storage content_lock:weapon_stats