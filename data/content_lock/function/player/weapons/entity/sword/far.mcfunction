...
data merge storage content_lock:weapon_stats {xz:0.5,y:0.1,UUID:[I;0,0,0,0],damage_type:"melee",pitch:0,yaw:0,distance:0,storage:"content_lock:weapon_stats",physical_damage:0,fire_damage:0,frost_damage:0,magic_damage:0,wither_damage:0,ender_damage:0}
execute if entity @s[tag=content_lock.weapons.hit3] run data merge storage content_lock:weapon_stats {xz:0.2,y:0.4,2xz:0.4,2y:0.8,UUID:[I;0,0,0,0],damage_type:"melee",pitch:0,yaw:0,distance:0,storage:"content_lock:weapon_stats",physical_damage:0,fire_damage:0,frost_damage:0,magic_damage:0,wither_damage:0,ender_damage:0}
execute if entity @s[tag=content_lock.weapons.hit_running] run data merge storage content_lock:weapon_stats {xz:0.2,y:0.4,2xz:0.4,2y:0.8,UUID:[I;0,0,0,0],damage_type:"melee",pitch:0,yaw:0,distance:0,storage:"content_lock:weapon_stats",physical_damage:0,fire_damage:0,frost_damage:0,magic_damage:0,wither_damage:0,ender_damage:0}
