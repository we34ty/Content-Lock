...
execute if score @s content_lock.temp1 matches 15 run function animated_java:weapons/remove/this

data merge storage content_lock:weapon_stats {xz:0.4,y:0.4,2xz:0.8,2y:0.8,UUID:[I;0,0,0,0],damage:0,damage_type:player_attack,rotation:0,distance:0,storage:"content_lock:weapon_stats"}
