...
data merge storage content_lock:weapon_stats {xz:0.3,y:0.3,2xz:0.6,2y:0.6,UUID:[I;0,0,0,0],damage:0,damage_type:player_attack,pitch:0,yaw:0,distance:0,storage:"content_lock:weapon_stats"}
...
execute if score @s content_lock.attack_timer matches 8..9 rotated ~ 0 positioned ^ ^ ^1 run function content_lock:player/weapons/entity/damage with storage content_lock:weapon_stats
