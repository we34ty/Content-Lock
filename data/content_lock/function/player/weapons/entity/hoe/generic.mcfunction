...
data merge storage content_lock:weapon_stats {xz:0.15,y:0.45,UUID:[I;0,0,0,0],damage:0,damage_type:player_attack,pitch:0,yaw:0,distance:0,storage:"content_lock:weapon_stats"}
