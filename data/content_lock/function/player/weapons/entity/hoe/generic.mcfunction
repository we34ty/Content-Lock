...
data merge storage content_lock:weapon_stats {xz:0.2,y:0.45,UUID:[I;0,0,0,0],damage:0,damage_type:"content_lock:multihit",pitch:0,yaw:0,distance:0,storage:"content_lock:weapon_stats"}
