...
data modify storage content_lock:saved_stats cached_armor append from entity @s equipment.feet.components."minecraft:custom_data"."content_lock:armor"
data modify storage content_lock:saved_stats cached_armor append from entity @s equipment.legs.components."minecraft:custom_data"."content_lock:armor"
data modify storage content_lock:saved_stats cached_armor append from entity @s equipment.chest.components."minecraft:custom_data"."content_lock:armor"
data modify storage content_lock:saved_stats cached_armor append from entity @s equipment.head.components."minecraft:custom_data"."content_lock:armor"

data merge storage content_lock:saved_stats {storage:"content_lock:weapon_stats",path:"armor",damage_resistances:{},status_effect_resistances:{}}
