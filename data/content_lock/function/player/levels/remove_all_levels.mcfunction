...
scoreboard players set @s content_lock.atkrng_from_level 0
scoreboard players set @s content_lock.eqld_from_level 0
scoreboard players set @s content_lock.dmg_from_level 0
