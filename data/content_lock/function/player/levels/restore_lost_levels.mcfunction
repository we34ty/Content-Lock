...
execute if score @s content_lock.xp_point_old < @s content_lock.xp_point if score @s content_lock.temp1 > @s content_lock.xp_level run scoreboard players add @s content_lock.xp_level 1
...
execute if score @s content_lock.xp_point_old > @s content_lock.xp_point if score @s content_lock.xp_level_old > @s content_lock.xp_level run scoreboard players add @s content_lock.xp_level 1
...
execute if score @s content_lock.xp_point_old > @s content_lock.xp_point run scoreboard players add @s content_lock.xp_point 1
...
execute if score @s content_lock.xp_point_old < @s content_lock.xp_point run xp add @s -1 points
execute if score @s content_lock.xp_point_old < @s content_lock.xp_point run scoreboard players remove @s content_lock.xp_point 1
execute if score @s content_lock.xp_point_old < @s content_lock.xp_point run function content_lock:player/levels/restore_lost_levels
