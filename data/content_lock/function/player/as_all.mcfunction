...
##track how long the player has been in the dark
execute at @s if dimension overworld if predicate content_lock:so_real_for_dark run scoreboard players add @s content_lock.dark_timer 1
execute at @s unless predicate content_lock:so_real_for_dark run scoreboard players set @s content_lock.dark_timer 0
execute at @s unless dimension overworld run scoreboard players set @s content_lock.dark_timer 0
execute if score @s content_lock.dark_timer matches 100.. run effect give @s minecraft:darkness 2 0 true
execute if score @s content_lock.dark_timer matches 150 at @s run function content_lock:player/passives/random_sounds/dark_sound
