...
data merge storage content_lock:saved_stats {bleed:E004,frost:E009,corruption:E014,stamina:E016,UUID:[I;0,0,0,0],storage:"content_lock:saved_stats"}
data modify storage content_lock:saved_stats UUID set from entity @s UUID
function content_lock:player/passives/player_data_load with storage content_lock:saved_stats
