...
execute if score @s content_lock.frostbite_stacks matches 350.. run function content_lock:player/effects/frostbite
...
execute if score @s content_lock.frostbite_stacks matches 20.. run scoreboard players remove @s content_lock.frostbite_stacks 20
execute if score @s content_lock.frostbite_stacks matches ..-1 run scoreboard players add @s content_lock.frostbite_stacks 20
execute if score @s content_lock.frostbite_stacks matches 1..19 run scoreboard players remove @s content_lock.frostbite_stacks 1
