...
execute if score @s[tag=content_lock.frostbite_active] content_lock.frostbite_stacks matches ..0 run function content_lock:player/effects/frostbite_remove


execute if score @s content_lock.bleed_stacks matches 1.. run scoreboard players remove @s content_lock.bleed_stacks 2

execute if score @s content_lock.frostbite_stacks matches 1.. if entity @s[tag=content_lock.frostbite_active] run scoreboard players remove @s content_lock.frostbite_stacks 7
execute if score @s content_lock.frostbite_stacks matches 1.. unless entity @s[tag=content_lock.frostbite_active] run scoreboard players remove @s content_lock.frostbite_stacks 1
execute if score @s content_lock.frostbite_stacks matches ..-1 unless entity @s[tag=content_lock.frostbite_active] run scoreboard players add @s content_lock.frostbite_stacks 1
