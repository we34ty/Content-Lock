...
execute if score @s content_lock.temp1 matches 1 run attribute @s attack_knockback modifier add content_lock.iron_grip 0.2 add_multiplied_total
...
execute if score @s content_lock.temp1 matches 1 run attribute @s movement_efficiency modifier add content_lock.iron_grip -0.01 add_multiplied_base
...
execute if score @s content_lock.temp1 matches 2 run attribute @s attack_knockback modifier add content_lock.iron_grip 0.35 add_multiplied_total
...
execute if score @s content_lock.temp1 matches 2 run attribute @s movement_efficiency modifier add content_lock.iron_grip -0.02 add_multiplied_base
...
execute if score @s content_lock.temp1 matches 3.. run attribute @s attack_knockback modifier add content_lock.iron_grip 0.5 add_multiplied_total
...
execute if score @s content_lock.temp1 matches 3.. run attribute @s movement_efficiency modifier add content_lock.iron_grip -0.03 add_multiplied_base
