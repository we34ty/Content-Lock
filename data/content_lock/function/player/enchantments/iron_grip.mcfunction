...
execute if score @s content_lock.temp1 matches 1 run attribute @s attack_damage modifier add content_lock.iron_grip 0.05 add_multiplied_base
...
execute if score @s content_lock.temp1 matches 2 run attribute @s attack_damage modifier add content_lock.iron_grip 0.10 add_multiplied_base
...
execute if score @s content_lock.temp1 matches 3.. run attribute @s attack_damage modifier add content_lock.iron_grip 0.15 add_multiplied_base
