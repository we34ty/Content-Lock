...
execute if score L content_lock.timer1 matches 16 if entity @e[type=iron_golem,tag=!content_lock.customized] as @e[type=iron_golem,tag=!content_lock.customized] run function content_lock:mobs/customization/iron_golem
