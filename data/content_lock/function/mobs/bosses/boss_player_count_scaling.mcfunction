...
#execute if entity @n[tag=content_lock.boss,distance=1..] unless entity @s[type=ender_dragon] unless entity @s[type=wither] run function content_lock:mobs/bosses/boss_despawn
execute if entity @n[type=wither,distance=1..] unless entity @s[type=ender_dragon] unless entity @s[type=wither] run function content_lock:mobs/bosses/boss_despawn
execute if entity @n[type=ender_dragon,distance=1..] unless entity @s[type=ender_dragon] unless entity @s[type=wither] run function content_lock:mobs/bosses/boss_despawn
