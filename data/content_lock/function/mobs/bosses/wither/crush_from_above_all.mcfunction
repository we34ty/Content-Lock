...
execute if entity @s[scores={content_lock.attack_timer=80}] at @e[type=#content_lock:boss_can_damage,distance=..10] run summon marker ~ ~5 ~ {Tags:["content_lock.wither.crush_from_above_all.pointer"]}
...
execute if entity @s[scores={content_lock.attack_timer=40}] at @e[type=#content_lock:boss_can_damage,distance=..10] run summon marker ~ ~5 ~ {Tags:["content_lock.wither.crush_from_above_all.pointer"]}
