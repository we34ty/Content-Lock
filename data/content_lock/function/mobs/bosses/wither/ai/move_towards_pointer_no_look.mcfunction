...
$execute positioned ^ ^ ^$(speed) if block ~ ~ ~ #walkable run tp @s ~ ~ ~ ~ ~
...
$execute if score @s content_lock.temp1 matches 0 rotated ~ 0 positioned ^ ^ ^$(speed) if block ~ ~ ~ #walkable if block ~ ~3 ~ #walkable run tp @s ~ ~ ~ ~ ~
...
$execute if score @s content_lock.temp1 matches 0 rotated ~90 0 positioned ^ ^ ^$(speed) if block ~ ~ ~ #walkable if block ~ ~3 ~ #walkable run tp @s ~ ~ ~ ~ ~
...
#$execute if score @s content_lock.temp1 matches 0 rotated ~180 0 positioned ^ ^ ^$(speed) if block ~ ~ ~ #walkable run tp @s ~ ~ ~ ~ ~
...
$execute if score @s content_lock.temp1 matches 0 positioned ~ ~$(vertical_speed) ~ if block ~ ~ ~ #walkable if block ~ ~3 ~ #walkable run tp @s ~ ~ ~ ~ ~
