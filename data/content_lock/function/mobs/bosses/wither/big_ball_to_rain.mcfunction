...
execute if entity @s[scores={content_lock.attack_timer=200}] at @e[tag=content_lock.wither.big_ball_to_rain.pointer] run particle soul_fire_flame ~ ~8 ~ 3 3 3 1 20 normal @a
execute if entity @s[scores={content_lock.attack_timer=200}] at @e[tag=content_lock.wither.big_ball_to_rain.pointer] run particle soul ~ ~8 ~ 3 3 3 1 20 normal @a
execute if entity @s[scores={content_lock.attack_timer=200}] at @e[tag=content_lock.wither.big_ball_to_rain.pointer] run particle dust{color:4276551,scale:3} ~ ~8 ~ 5 1 5 1 120 force @a
...
execute if entity @s[scores={content_lock.attack_timer=10..120}] as @e[tag=content_lock.wither.big_ball_to_rain.rain_pointer,tag=!content_lock.wither.big_ball_to_rain.rain_pointer.launched,limit=1,sort=random] run tag @s add content_lock.wither.big_ball_to_rain.rain_pointer.launched
