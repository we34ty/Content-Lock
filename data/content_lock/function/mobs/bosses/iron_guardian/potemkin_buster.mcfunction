...
execute if entity @s[scores={content_lock.attack_timer=190}] positioned ^ ^ ^3 positioned ~-3 ~-1 ~-3 as @e[type=#content_lock:boss_can_damage,dx=6,dy=6,dz=6] run tag @s add content_lock.caught_in_potemkin_buster
