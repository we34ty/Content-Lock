...
execute if entity @s[scores={content_lock.attack_timer=..150}] run summon area_effect_cloud ~ ~ ~ {Tags:[content_lock.direction_to_look_for_iron_guardian],Radius:0.0f}
