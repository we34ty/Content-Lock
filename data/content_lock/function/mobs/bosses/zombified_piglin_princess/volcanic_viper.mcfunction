...
execute if entity @s[scores={content_lock.attack_timer=50..60}] positioned ~-4 ~-2 ~-4 as @e[type=#content_lock:boss_can_damage,dx=8,dy=8,dz=8,type=!player] run data merge entity @s {Motion:[0.0d,0.6d,0.0d]}
