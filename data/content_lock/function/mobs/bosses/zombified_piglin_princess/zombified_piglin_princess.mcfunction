...
execute if entity @s[tag=content_lock.zombified_piglin_princess.phase2] run function content_lock:mobs/bosses/music/boss_music {song:music.content_lock.corrupted_princess,duration:3940}
execute unless entity @s[tag=content_lock.zombified_piglin_princess.phase2] run function content_lock:mobs/bosses/music/boss_music {song:music.content_lock.corrupted_princess_enemies,duration:3860}
