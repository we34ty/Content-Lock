...
execute at @s unless biome ~ ~ ~ minecraft:nether_wastes run scoreboard players set @s content_lock.temp1 4
execute if score @s content_lock.temp1 matches 4 run title @s times 2 8 3
execute if score @s content_lock.temp1 matches 4 run title @s actionbar [{"translate":"content_lock:notifications.can_only_spawn_in_nether_wastes","color":"dark_red"}]
execute if score @s content_lock.temp1 matches 4 run return 0
