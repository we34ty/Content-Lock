...
execute unless dimension minecraft:the_nether unless biome ~ ~ ~ minecraft:nether_wastes run scoreboard players set @s content_lock.temp1 1
...
summon zombified_piglin ~ ~ ~ {Health:600,Glowing:1b,PersistenceRequired:1b,CustomName:'[{"translate":"content_lock:boss.zombified_piglin_princess","color":"gold","bold":true}]',Tags:["content_lock.boss","content_lock.zombified_piglin_princess","content_lock.customized"],CustomNameVisible:1b,ArmorItems:[{},{},{id:golden_chestplate,components:{trim:{pattern:silence,material:quartz},enchantments:{levels:{fire_protection:4}},attribute_modifiers:{modifiers:[{type:armor,amount:0,slot:chest,operation:add_value,id:"content_lock.zombified_piglin_princess"}]}}},{id:piglin_head,components:{enchantments:{levels:{fire_protection:4}},attribute_modifiers:{modifiers:[{type:armor,amount:0,slot:chest,operation:add_value,id:"content_lock.zombified_piglin_princess"}]}}}],ArmorDropChances:[0f,0f,0f,0f],attributes:[{id:max_health,base:600f},{id:attack_damage,base:4f},{id:movement_speed,base:0.2f},{id:knockback_resistance,base:0.1f},{id:scale,base:1.4f}]}
