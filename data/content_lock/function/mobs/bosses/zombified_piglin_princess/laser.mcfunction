...
execute if entity @s[scores={content_lock.attack_timer=200}] at @e[tag=content_lock.im_a_target,limit=1,sort=nearest,type=#content_lock:boss_can_damage] run summon area_effect_cloud ~ ~1 ~ {Duration:21,Tags:["content_lock.zombified_piglin_princess.laser.begin_area"],custom_particle:{type:"block",block_state:"air"}}
execute if entity @s[scores={content_lock.attack_timer=180}] run summon area_effect_cloud ~ ~2 ~ {Duration:61,Tags:["content_lock.zombified_piglin_princess.laser.area"],custom_particle:{type:"block",block_state:"air"}}
...
execute if entity @s[scores={content_lock.attack_timer=120..179}] as @e[tag=content_lock.zombified_piglin_princess.laser.area] at @s run summon area_effect_cloud ~ ~ ~ {Tags:[content_lock.zombified_piglin_princess.laser.area.direction],custom_particle:{type:"block",block_state:"air"},Duration:0}
execute if entity @s[scores={content_lock.attack_timer=120..179}] as @e[tag=content_lock.zombified_piglin_princess.laser.area] at @s run execute as @e[tag=content_lock.zombified_piglin_princess.laser.area.direction,limit=1,sort=nearest] at @s facing entity @e[tag=content_lock.im_a_target,limit=1,sort=nearest,type=#content_lock:boss_can_damage] eyes run rotate @s ~ ~
...
execute if entity @s[scores={content_lock.attack_timer=120}] if entity @e[tag=content_lock.im_a_target,type=#content_lock:boss_can_damage] positioned ~-8 ~-8 ~-8 unless entity @e[tag=content_lock.im_a_target,limit=1,sort=nearest,dx=16,dy=16,dz=16] run scoreboard players set @s content_lock.attack_timer 10
