...
execute if score @s content_lock.attack_timer matches 0 run summon minecraft:zombified_piglin ~ ~-2 ~ {attributes:[{id:"max_health",base:10},{id:"attack_damage",base:1},{id:"movement_speed",base:0.16},{id:"fall_damage_multiplier",base:-1}],Tags:["content_lock.can_cast_fireball","content_lock.zombified_piglin_princess.minion"]}
execute if score @s content_lock.attack_timer matches 0 run summon minecraft:zombified_piglin ~ ~-2 ~ {attributes:[{id:"max_health",base:10},{id:"attack_damage",base:1},{id:"movement_speed",base:0.16},{id:"fall_damage_multiplier",base:-1}],Tags:["content_lock.can_cast_fireball","content_lock.zombified_piglin_princess.minion"]}
execute if score @s content_lock.attack_timer matches 0 run summon minecraft:zombified_piglin ~ ~-2 ~ {attributes:[{id:"max_health",base:10},{id:"attack_damage",base:1},{id:"movement_speed",base:0.16},{id:"fall_damage_multiplier",base:-1}],Tags:["content_lock.can_cast_fireball","content_lock.zombified_piglin_princess.minion"]}
execute if score @s content_lock.attack_timer matches 0 run summon minecraft:zombified_piglin ~ ~-2 ~ {attributes:[{id:"max_health",base:10},{id:"attack_damage",base:1},{id:"movement_speed",base:0.16},{id:"fall_damage_multiplier",base:-1}],Tags:["content_lock.can_cast_fireball","content_lock.zombified_piglin_princess.minion"]}
