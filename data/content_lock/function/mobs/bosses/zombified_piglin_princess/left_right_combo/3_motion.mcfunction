$execute facing entity @e[tag=content_lock.zombified_piglin_princess.left_right_combo.3.area,limit=1,sort=nearest] feet rotated ~ 0 positioned ^ ^ ^$(boss_speed) run summon area_effect_cloud ~ ~ ~ {Tags:["content_lock.motion_saved_boss"]}
