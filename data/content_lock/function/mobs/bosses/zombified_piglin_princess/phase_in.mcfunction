...
execute if entity @s[scores={content_lock.attack_timer=140}] at @e[tag=content_lock.im_a_target,limit=1,sort=nearest,type=#content_lock:boss_can_damage] run summon area_effect_cloud ~ ~ ~ {Duration:21,Tags:["content_lock.zombified_piglin_princess.phase_in.area"],custom_particle:{type:"block",block_state:"air"}}
...
execute if entity @s[scores={content_lock.attack_timer=110}] unless score @s content_lock.combo_counter matches 2.. positioned ~-4 ~-4 ~-4 if entity @e[tag=content_lock.im_a_target,type=#content_lock:boss_can_damage,dx=8,dy=8,dz=8] run tag @s add content_lock.zombified_piglin_princess.phase_in.combo1
...
execute if entity @s[scores={content_lock.attack_timer=110}] at @e[tag=content_lock.im_a_target,limit=1,sort=nearest,type=#content_lock:boss_can_damage] run summon area_effect_cloud ~ ~ ~ {Duration:21,Tags:["content_lock.zombified_piglin_princess.phase_in.combo1.area"],custom_particle:{type:"block",block_state:"air"}}
