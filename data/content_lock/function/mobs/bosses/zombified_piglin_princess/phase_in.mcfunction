...
execute if entity @s[scores={content_lock.attack_timer=140}] at @e[tag=content_lock.im_a_target,limit=1,sort=nearest,type=#minecraft:boss_can_damage] run summon area_effect_cloud ~ ~ ~ {Duration:21,Tags:["content_lock.zombified_piglin_princess.phase_in.area"],Radius:0.0f}
...
execute if entity @s[scores={content_lock.attack_timer=110}] at @e[tag=content_lock.im_a_target,limit=1,sort=nearest,type=#minecraft:boss_can_damage] run summon area_effect_cloud ~ ~ ~ {Duration:21,Tags:["content_lock.zombified_piglin_princess.phase_in.combo1.area"],Radius:0.0f}
