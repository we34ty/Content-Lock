$execute facing entity @e[tag=content_lock.zombified_piglin_princess.bandit_bringer.area,limit=1,sort=nearest] feet positioned ^ ^ ^$(boss_speed) run summon area_effect_cloud ~ ~ ~ {Tags:["content_lock.motion_saved_boss"],Radius:0.0f}
