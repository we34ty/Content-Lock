...
execute unless entity @s[tag=content_lock.zombified_piglin_princess.fireball.area.started] facing entity @e[tag=content_lock.im_a_target,limit=1,sort=nearest,type=#content_lock:boss_can_damage] eyes run rotate @s ~ ~
...
#execute rotated ~ 0 positioned ~ ~0.5 ~ unless block ^ ^ ^1 #walkable facing entity @e[tag=content_lock.im_a_target,limit=1,sort=nearest,type=#content_lock:boss_can_damage] eyes run rotate @s ~ ~
