...
execute rotated as @p facing entity @e[type=#minecraft:boss_can_damage,tag=content_lock.im_a_target] eyes positioned ^ ^ ^1.4 run summon area_effect_cloud ~ ~ ~ {Tags:["content_lock.motion_saved_boss"],custom_particle:{type:"block",block_state:"air"},Duration:0}
