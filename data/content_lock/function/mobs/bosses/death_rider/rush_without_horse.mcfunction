...
execute if entity @s[scores={content_lock.attack_timer=131}] facing entity @n[tag=content_lock.im_a_target,type=#boss_can_damage] feet rotated ~ 0 run summon area_effect_cloud ^ ^ ^40 {Duration:32,Tags:[content_lock.death_rider.rush_without_horse.area],custom_particle:{type:"block",block_state:"air"}}
...
execute if entity @s[scores={content_lock.attack_timer=110..130}] positioned ~-1 ~-1 ~-1 if entity @e[tag=content_lock.im_a_target,type=#boss_can_damage,dx=2,dy=2,dz=2] at @n[tag=content_lock.death_rider_horse] run particle soul ~ ~1 ~ 0.3 0.3 0.3 0.4 40 normal @a
...
execute if entity @s[scores={content_lock.attack_timer=110..130}] positioned ~-1 ~-1 ~-1 if entity @e[tag=content_lock.im_a_target,type=#boss_can_damage,dx=2,dy=2,dz=2] run tp @n[tag=content_lock.death_rider_horse] @s
