...
execute unless predicate content_lock:is_night run scoreboard players set @s content_lock.temp1 3
execute if score @s content_lock.temp1 matches 3 run title @s times 2 8 3
execute if score @s content_lock.temp1 matches 3 run title @s actionbar [{"translate":"content_lock:notifications.can_only_spawn_at_night","color":"dark_red"}]
execute if score @s content_lock.temp1 matches 3 run return 0
