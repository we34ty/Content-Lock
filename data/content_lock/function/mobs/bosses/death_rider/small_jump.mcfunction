...
execute if entity @s[scores={content_lock.attack_timer=69}] as @e[tag=content_lock.death_rider_horse,limit=1,sort=nearest] run data merge entity @s {Motion:[0.0d,1.0d,0.0d]}
