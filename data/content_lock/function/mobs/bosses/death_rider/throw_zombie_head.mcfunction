...
execute if entity @s[scores={content_lock.attack_timer=60}] facing entity @e[tag=content_lock.im_a_target,type=#content_lock:boss_can_damage] eyes run rotate @s ~ 0
