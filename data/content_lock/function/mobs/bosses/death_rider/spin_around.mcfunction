...
execute if entity @s[scores={content_lock.attack_timer=180}] as @n[tag=content_lock.death_rider_horse] run attribute @s movement_speed modifier add content_lock.no_speed -1 add_multiplied_total

execute if entity @s[scores={content_lock.attack_timer=180}] at @n[tag=content_lock.death_rider_horse] run playsound entity.zombie_horse.ambient hostile @a ~ ~ ~ 2 1
...
execute if entity @s[scores={content_lock.attack_timer=120}] as @n[tag=content_lock.death_rider_horse] run attribute @s movement_speed modifier remove content_lock.no_speed
