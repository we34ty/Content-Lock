...
execute if entity @s[scores={content_lock.attack_timer=120..159}] positioned ~ ~1.5 ~ run particle soul_fire_flame ^ ^ ^3 0.2 0.2 0.2 0.04 10 force @a
execute if entity @s[scores={content_lock.attack_timer=120..159}] positioned ~ ~1.5 ~ positioned ^ ^ ^3 run function content_lock:mobs/bosses/universal/damage_player_d {half_distance:1,distance:2,damage:6,damage_type:mob_attack}
