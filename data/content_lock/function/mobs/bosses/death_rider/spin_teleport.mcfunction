...
execute if entity @s[scores={content_lock.attack_timer=120}] as @n[tag=content_lock.death_rider_horse] run attribute @s movement_speed modifier add content_lock.no_speed -1 add_multiplied_total

execute if entity @s[scores={content_lock.attack_timer=120}] run playsound block.beacon.activate hostile @a ~ ~ ~ 3 1
execute if entity @s[scores={content_lock.attack_timer=120}] at @n[tag=content_lock.im_a_target,type=#content_lock:boss_can_damage] run summon area_effect_cloud ~ ~ ~ {Duration:41,Tags:["content_lock.death_rider.spin_teleport.area"],custom_particle:{type:"block",block_state:"air"}}
...
execute if entity @s[scores={content_lock.attack_timer=80}] at @n[tag=content_lock.death_rider.spin_teleport.area] run tp @n[tag=content_lock.death_rider_horse] ~ ~ ~
...
execute if entity @s[scores={content_lock.attack_timer=60}] as @n[tag=content_lock.death_rider_horse] run attribute @s movement_speed modifier remove content_lock.no_speed
