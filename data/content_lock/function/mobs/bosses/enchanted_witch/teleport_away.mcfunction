...
execute if entity @s[scores={content_lock.attack_timer=160}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run effect give @s slowness 3 2 true
execute if entity @s[scores={content_lock.attack_timer=160}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run effect give @s jump_boost 3 5 true
...
execute if entity @s[scores={content_lock.attack_timer=160}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run effect give @s resistance 1 4 true
execute if entity @s[scores={content_lock.attack_timer=160}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run damage @s 1 mob_attack by @e[tag=content_lock.enchanted_witch,limit=1]
execute if entity @s[scores={content_lock.attack_timer=159}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run effect clear @s resistance
execute if entity @s[scores={content_lock.attack_timer=140}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run effect give @s resistance 1 4 true
execute if entity @s[scores={content_lock.attack_timer=140}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run damage @s 1 mob_attack by @e[tag=content_lock.enchanted_witch,limit=1]
execute if entity @s[scores={content_lock.attack_timer=139}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run effect clear @s resistance
execute if entity @s[scores={content_lock.attack_timer=120}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run effect give @s resistance 1 4 true
execute if entity @s[scores={content_lock.attack_timer=120}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run damage @s 1 mob_attack by @e[tag=content_lock.enchanted_witch,limit=1]
execute if entity @s[scores={content_lock.attack_timer=119}] positioned ~-7 ~-7 ~-7 as @e[type=#content_lock:boss_can_damage,dx=14,dy=14,dz=14] run effect clear @s resistance
