...
execute if entity @e[tag=content_lock.boss,distance=0..80] run stopsound @s[tag=content_lock.listening_to_music] music custom.danger1
execute if entity @e[tag=content_lock.boss,distance=0..80] run stopsound @s[tag=content_lock.listening_to_music] music custom.danger2
