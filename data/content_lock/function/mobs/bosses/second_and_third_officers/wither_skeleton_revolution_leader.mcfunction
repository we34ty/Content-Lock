...
execute if entity @e[tag=ghast_revolution_leader,distance=0..40] run function content_lock:bosses/boss_music {song:content_lock:music.both_officers,duration:4400}
execute unless entity @e[tag=ghast_revolution_leader,distance=0..40] run function content_lock:bosses/boss_music {song:content_lock:music.one_officer,duration:5520}
