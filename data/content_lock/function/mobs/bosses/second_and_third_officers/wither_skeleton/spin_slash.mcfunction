...
execute if score @s content_lock.attack_timer matches 50..52 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^ ^ ^1.5 positioned ~ ~1 ~ run function content_lock:mobs/bosses/universal/damage_player_d {damage:6,damage_type:mob_attack,half_distance:1,distance:2}
execute if score @s content_lock.attack_timer matches 47..49 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^1.6 ^ ^ positioned ~ ~1 ~ run function content_lock:mobs/bosses/universal/damage_player_d {damage:6,damage_type:mob_attack,half_distance:1.1,distance:2.2}
execute if score @s content_lock.attack_timer matches 45..46 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^ ^ ^-1.7 positioned ~ ~1 ~ run function content_lock:mobs/bosses/universal/damage_player_d {damage:6,damage_type:mob_attack,half_distance:1.2,distance:2.4}
execute if score @s content_lock.attack_timer matches 42..44 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^-1.8 ^ ^ positioned ~ ~1 ~ run function content_lock:mobs/bosses/universal/damage_player_d {damage:6,damage_type:mob_attack,half_distance:1.3,distance:2.6}
execute if score @s content_lock.attack_timer matches 39..41 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^ ^ ^1.9 positioned ~ ~1 ~ run function content_lock:mobs/bosses/universal/damage_player_d {damage:6,damage_type:mob_attack,half_distance:1.4,distance:2.8}
execute if score @s content_lock.attack_timer matches 36..38 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^2 ^ ^ positioned ~ ~1 ~ run function content_lock:mobs/bosses/universal/damage_player_d {damage:6,damage_type:mob_attack,half_distance:1.5,distance:3}
execute if score @s content_lock.attack_timer matches 33..35 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^ ^ ^-2.1 positioned ~ ~1 ~ run function content_lock:mobs/bosses/universal/damage_player_d {damage:6,damage_type:mob_attack,half_distance:1.6,distance:3.2}
execute if score @s content_lock.attack_timer matches 30..32 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^-2.2 ^ ^ positioned ~ ~1 ~ run function content_lock:mobs/bosses/universal/damage_player_d {damage:6,damage_type:mob_attack,half_distance:1.7,distance:3.4}

execute if score @s content_lock.attack_timer matches 28 facing entity @n[tag=content_lock.second_officer.temp_target] feet rotated ~ 0 positioned ^ ^ ^2 run function content_lock:mobs/bosses/universal/damage_player_d {damage:10,damage_type:explosion,half_distance:3,distance:6}
