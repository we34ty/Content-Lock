...
execute unless entity @e[tag=wither_skeleton_revolution_leader,distance=0..40] run function content_lock:mobs/bosses/music/boss_music {song:"content_lock:music.one_officer",duration:276}
