...
execute at @n[tag=content_lock.third_officer.mount] if block ~ ~2 ~ #walkable rotated as @s run tp @s ~ ~-2 ~
execute at @n[tag=content_lock.third_officer.mount] unless block ~ ~2 ~ #walkable rotated as @s run tp @s ~ ~-2 ~
