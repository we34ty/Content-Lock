...
execute if entity @s[scores={content_lock.attack_timer=60}] run tag @s add content_lock.third_officer.attacking

execute if entity @s[scores={content_lock.attack_timer=60}] run playsound entity.ghast.warn hostile @a ~ ~ ~ 4 1.2
execute if entity @s[scores={content_lock.attack_timer=50}] run playsound entity.ghast.warn hostile @a ~ ~ ~ 4 1.6
...
execute if entity @s[scores={content_lock.attack_timer=40}] run tag @s remove content_lock.third_officer.stun_knockback