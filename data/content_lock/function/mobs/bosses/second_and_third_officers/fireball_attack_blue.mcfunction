...
execute if entity @s[scores={attack_timer=1..}] run tp @s ~ ~ ~ facing entity @p feet
execute if entity @s[scores={attack_timer=1}] run summon area_effect_cloud ^ ^ ^3 {Duration:141,Tags:["ghast_revolution_leader_fireball_blue"]}
execute if entity @s[scores={attack_timer=10}] run summon area_effect_cloud ^3 ^ ^3 {Duration:141,Tags:["ghast_revolution_leader_fireball_blue"]}
execute if entity @s[scores={attack_timer=20}] run summon area_effect_cloud ^-3 ^ ^3 {Duration:141,Tags:["ghast_revolution_leader_fireball_blue"]}
...
execute if entity @s[scores={attack_timer=61}] run tag @s remove fireball_attack_blue