...
execute if entity @s[type=#content_lock:zombies] run return run function content_lock:mobs/passives/scaling/zombie
...
execute if entity @s[type=#content_lock:spiders] run return run function content_lock:mobs/passives/scaling/spider
