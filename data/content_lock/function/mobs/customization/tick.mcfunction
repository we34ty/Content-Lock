...
execute if entity @s[tag=content_lock.enemy_fireball,type=area_effect_cloud] run function content_lock:mobs/customization/active/flying_fireball
...
execute if entity @s[type=minecraft:block_display,tag=content_lock.death_rider.throw_zombie_head.display] run function content_lock:mobs/customization/active/zombie_head
