...
execute if entity @s[type=#content_lock:zombies] at @p run playsound entity.zombie.hurt hostile @a ~ ~ ~ 1 0.8
execute if entity @s[type=#content_lock:rideable_healthbar] at @p run playsound entity.skeleton.hurt hostile @a ~ ~ ~ 1 0.8
