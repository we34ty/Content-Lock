...
execute if entity @r[tag=content_lock.im_a_target,distance=..5] if score @s content_lock.temp2 matches 2.. if score @s content_lock.temp1 matches 1 run function content_lock:mobs/customization/active/charged_jump
execute store result score @s content_lock.temp1 run function content_lock:check_random_chance {chance:100}
execute unless entity @r[tag=content_lock.im_a_target] if score @s content_lock.temp2 matches 2.. if score @s content_lock.temp1 matches 1 run function content_lock:mobs/customization/active/charged_jump
execute store result score @s content_lock.temp1 run function content_lock:check_random_chance {chance:100}
tag @a remove content_lock.im_a_target