...
execute at @s facing entity @p[tag=content_lock.im_a_target] eyes positioned ^ ^ ^0.8 run summon area_effect_cloud ~ ~ ~ {Tags:[content_lock.dash_to_player_point],custom_particle:{type:"block",block_state:"air"},Duration:0}
