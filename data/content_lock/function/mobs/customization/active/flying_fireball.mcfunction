...
execute at @s positioned ~-0.5 ~-0.5 ~-0.5 if entity @r[dx=1,dy=1,dz=1] positioned ~0.5 ~0.5 ~0.5 run function content_lock:mobs/bosses/universal/damage_player_d {half_distance:1.5,distance:3,damage:8,damage_type:fireball}
