...
execute at @s if entity @p[tag=content_lock.im_a_target,distance=3..6] if score @s content_lock.temp1 matches 1 run function content_lock:mobs/customization/active/dash_at_player
