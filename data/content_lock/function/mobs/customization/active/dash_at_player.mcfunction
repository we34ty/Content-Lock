execute at @s facing entity @p[tag=content_lock.im_a_target] eyes positioned ^ ^ ^1.1 run summon area_effect_cloud ~ ~ ~ {Tags:[content_lock.dash_to_player_point],Radius:0.0f}
