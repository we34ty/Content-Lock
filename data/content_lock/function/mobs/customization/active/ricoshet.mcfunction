...
execute at @s facing entity @e[type=!#entities,limit=1,sort=nearest] eyes positioned ^ ^ ^10.1 run summon area_effect_cloud ~ ~ ~ {Tags:[content_lock.dash_to_player_point]}
