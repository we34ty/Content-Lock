...
data merge entity @s {Silent:1b,DrownedConversionTime:100000000,DeathLootTable:"content_lock:entities/living_armor",CustomName:{"translate": "content_lock:mob.living_armor"},CustomNameVisible:0b,drop_chances:{body:0,chest:0,feet:0,head:0,legs:0}}
