...
execute if score @s content_lock.stored_y matches ..5 run playsound content_lock:item.prism_stone.small player @a ~ ~ ~ 10 1
execute if score @s content_lock.stored_y matches 6..12 run playsound content_lock:item.prism_stone.medium player @a ~ ~ ~ 10 1
execute if score @s content_lock.stored_y matches 13..25 run playsound content_lock:item.prism_stone.big player @a ~ ~ ~ 10 1
execute if score @s content_lock.stored_y matches 26.. run playsound content_lock:item.prism_stone.deadly player @a ~ ~ ~ 10 1
