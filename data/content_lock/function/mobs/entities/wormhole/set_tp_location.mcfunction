...
execute as @n[tag=content_lock.wormhole.yet_to_be_teleported] at @s run function content_lock:mobs/entities/wormhole/tp_second_point with storage content_lock:saved_stats