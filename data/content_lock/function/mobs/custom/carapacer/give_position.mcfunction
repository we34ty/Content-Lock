...
execute if entity @e[tag=content_lock.carapacer.current,limit=1,sort=nearest,nbt={HurtTime:9s}] run playsound content_lock:entity.carapacer.damaged hostile @a ~ ~ ~ 1
