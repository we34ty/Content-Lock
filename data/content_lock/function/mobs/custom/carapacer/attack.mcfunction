...
execute if score @s content_lock.ai_option matches 5 positioned ^ ^ ^1 run execute positioned ~-1 ~-1 ~-1 if entity @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] as @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] run damage @s 4 mob_attack by @e[tag=content_lock.carapacer.current,limit=1] from @e[tag=content_lock.carapacer.current,limit=1]
execute if score @s content_lock.ai_option matches 5 positioned ^ ^ ^2 run execute positioned ~-1 ~-1 ~-1 if entity @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] as @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] run damage @s 4 mob_attack by @e[tag=content_lock.carapacer.current,limit=1] from @e[tag=content_lock.carapacer.current,limit=1]
execute if score @s content_lock.ai_option matches 5 positioned ^ ^ ^3 run execute positioned ~-1 ~-1 ~-1 if entity @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] as @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] run damage @s 4 mob_attack by @e[tag=content_lock.carapacer.current,limit=1] from @e[tag=content_lock.carapacer.current,limit=1]
execute if score @s content_lock.ai_option matches 5 positioned ^ ^ ^1 run execute positioned ~-1 ~-1 ~-1 if entity @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] as @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] run scoreboard players add @s content_lock.bleed_stacks 15
execute if score @s content_lock.ai_option matches 5 positioned ^ ^ ^1 run execute positioned ~-1 ~-1 ~-1 if entity @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] as @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] run scoreboard players add @s content_lock.bleed_stacks 15
execute if score @s content_lock.ai_option matches 5 positioned ^ ^ ^1 run execute positioned ~-1 ~-1 ~-1 if entity @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] as @e[type=#content_lock:boss_can_damage,tag=!content_lock.boss,dx=2,dy=2,dz=2] run scoreboard players add @s content_lock.bleed_stacks 15
