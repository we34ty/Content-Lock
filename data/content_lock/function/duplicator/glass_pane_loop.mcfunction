data merge storage content_lock:saved_stats {slot:0,model:"content_lock:block/duplicator/duplicator_main"}
execute if score @s content_lock.timer1 matches 0 run data merge storage content_lock:saved_stats {slot:0,model:"content_lock:block/duplicator/duplicator_display"}
execute if score @s content_lock.timer1 matches 18 run data merge storage content_lock:saved_stats {slot:0,model:"content_lock:block/duplicator/duplicator_display"}
execute if score @s content_lock.timer1 matches 9 run data merge storage content_lock:saved_stats {slot:0,model:"content_lock:block/duplicator/duplicator_vertical"}
execute if score @s content_lock.timer1 matches 13 run data merge storage content_lock:saved_stats {slot:0,model:"content_lock:block/duplicator/duplicator_arrow"}
execute unless items block ~ ~ ~ container.11 * if score @s content_lock.timer1 matches 10 run data merge storage content_lock:saved_stats {slot:0,model:"content_lock:block/duplicator/duplicator_icons"}
