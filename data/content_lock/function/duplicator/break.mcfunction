summon item ~ ~ ~ {Item:{id:zombie_spawn_egg,components:{item_name:{translate:"content_lock:item.duplicator",italic:false},entity_data:{id:"marker",Tags:["content_lock.duplicator"]},item_model:"barrel"}}}
