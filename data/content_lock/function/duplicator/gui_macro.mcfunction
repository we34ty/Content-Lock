...
$item replace block ~ ~ ~ container.$(slot) with black_stained_glass_pane[custom_data={"content_lock:clear_in_inventory":true},tooltip_display={hide_tooltip:true},item_model="$(model)"]
