...
scoreboard players operation @s content_lock.temp3 = @s content_lock.duplication_cost
...
data merge storage content_lock:saved_stats {item:"minecraft:nether_star",slot:1b,amount:1}
...
scoreboard players operation @s content_lock.temp3 *= @s content_lock.temp1
scoreboard players operation @s content_lock.temp2 = @s content_lock.duplication_cost
...
data merge storage content_lock:saved_stats {item:"minecraft:lapis_block",slot:2b,amount:1}
...
scoreboard players operation @s content_lock.temp2 *= @s content_lock.temp1
scoreboard players operation @s content_lock.temp1 = @s content_lock.duplication_cost
...
data merge storage content_lock:saved_stats {item:"minecraft:lapis_lazuli",slot:3b,amount:1}
