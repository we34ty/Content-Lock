...
execute at @a if entity @e[tag=aj.wormhole.root,distance=..40] at @e[tag=aj.wormhole.root,distance=..40] if block ~ ~-1 ~ #air run setblock ~ ~-1 ~ warped_nylium destroy
execute at @a if entity @e[tag=aj.wormhole.root,distance=..40] at @e[tag=aj.wormhole.root,distance=..40] unless block ~ ~ ~ #air run setblock ~ ~ ~ air destroy
execute at @a if entity @e[tag=aj.wormhole.root,distance=..40] at @e[tag=aj.wormhole.root,distance=..40] unless block ~ ~1 ~ #air run setblock ~ ~1 ~ air destroy
