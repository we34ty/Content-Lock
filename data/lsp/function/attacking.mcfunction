...
execute store result storage content_lock:saved_stats attack_speed float 0.01 run attribute @s attack_speed get 1000
...
scoreboard players set @s content_lock.temp2 7500
scoreboard players operation @s content_lock.temp2 /= @s content_lock.temp1
scoreboard players add @s content_lock.temp2 600
