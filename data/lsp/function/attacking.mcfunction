...
execute if score @s content_lock.temp1 matches 300.. run scoreboard players set @s content_lock.temp1 300
scoreboard players set @s content_lock.temp2 20000
