...
scoreboard players set @s quarry_temp_var 0
execute store result score @s quarry_temp_var run data get block ~ ~ ~ Items[{Slot:4b}].components."minecraft:enchantments".levels."minecraft:fortune"
scoreboard players add @s quarry_temp_var 1
