...
execute unless entity @s[tag=content_lock.quarry.miner.tagged] facing entity @e[tag=quarry,limit=1,sort=nearest] feet rotated as @e[tag=quarry,limit=1,sort=nearest] run tp @s ^ ^ ^1 ~-90 0
