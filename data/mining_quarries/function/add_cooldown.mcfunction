...
execute store result score @s content_lock.quarry_temp_var run data get block ~ ~ ~ Items[{Slot:4b}].components."minecraft:enchantments".levels."content_lock:weapon_level"
...
execute store result score @s content_lock.quarry_temp_var run data get block ~ ~ ~ Items[{Slot:4b}].components."minecraft:enchantments".levels."minecraft:efficiency"
scoreboard players operation @s content_lock.quarry_temp_var *= mining_quarry_2 content_lock.quarry_temp_var
scoreboard players operation @s content_lock.quarry_cooldown -= @s content_lock.quarry_temp_var
scoreboard players reset @s content_lock.quarry_temp_var